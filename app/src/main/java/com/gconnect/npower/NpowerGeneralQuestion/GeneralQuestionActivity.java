...
import com.gconnect.npower.GeneralActivity;
import com.gconnect.npower.GeneralAnswerActivity;
import com.gconnect.npower.NpowerGeneralQuestion.GeneralAnswer;
import com.gconnect.npower.NpowerGeneralQuestion.GeneralQuestion;
...
public class GeneralQuestionActivity extends AppCompatActivity {
    ...
    public void start (View view){
        Intent i = new Intent (GeneralQuestionActivity.this, GeneralActivity.class);
        startActivity(i);
    }

    public void viewanswer (View view){
        Intent i = new Intent (GeneralQuestionActivity.this, GeneralAnswerActivity.class);
        startActivity(i);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_general_question, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.general_question, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.gwelcome);

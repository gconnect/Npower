...
public class NpowerTeachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_npower_teach);
    ...
    public void start (View view){
        Intent i = new Intent (NpowerTeachActivity.this, TeachActivity.class);
        startActivity(i);
    }


    public void viewanswer (View view){
        Intent i = new Intent (NpowerTeachActivity.this, TeachAnswerActivity.class);
        startActivity(i);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_npower_teach, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    NpowerTeachQuestion teachQuestion = new NpowerTeachQuestion();
                    return teachQuestion;
                case 1:
                    NpowerTeachAnswer teachAnswer = new NpowerTeachAnswer();
                    return teachAnswer;
            }
            return null;
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return "Npower Teach Question";
                case 1:
                    return "Npower Teach Answers";
